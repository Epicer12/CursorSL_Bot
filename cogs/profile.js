...
const profileCommand = {
  ...
  async slashExecute(interaction, { db }) {
    ...
    const embed = new EmbedBuilder()
      ...
      .addFields(
        {
          name: "💻 Stack",
          value: profile?.stack || "Not set (Use /update-stack)",
          inline: false,
        },
        {
        ...
        {
          name: "🏆 Challenge Wins",
          value: `${profile?.challenge_wins || 0}`,
          inline: true,
        },
      )
      .setColor("#5865F2")
  ...
  async prefixExecute({ message, _args }, { db }) {
...
const updateStackCommand = {
  ...
  slashData: new SlashCommandBuilder()
    ...
    .setDescription(
      "Update your technical stack (e.g., 'React, Python, Cursor AI').",
    )
